...
exports.createUser = async (userInfo,res) => {
    
    const { username, email, firstname, lastname, age, password } = userInfo;
    ...
    user = await User.create({ username, email,firstname, lastname, age, password: hashedpassword });
